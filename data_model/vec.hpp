...
public:
    ...
    inline mmf mm() const { return _mm; }
    void setmm(const mmf& _mm) { this->_mm = _mm; }
    inline size_t mmsize();

    void load(const float *_arr) { _mm = _vloadf(_arr); }
    void store(float *_arr) { _vstoref(_arr, _mm); }

    inline Vec<float> & operator = (const Vec<float> & v) { this->_mm = v.mm(); return *this; }
    inline Vec<float> & operator = (const mmf & _mm) { this->_mm = _mm; return *this; }
#if mmf!=float
    inline Vec<float> & operator = (const float & f) { _mm = _vset1f(f); }
#endif
};

// 向量加
static inline Vec<float> operator + (const Vec<float> & v1, const Vec<float> & v2)
{ return Vec<float>(_vaddf(v1.mm(), v2.mm())); }

static inline Vec<float> operator + (const Vec<float> & v1, const mmf & v2)
{ return Vec<float>(_vaddf(v1.mm(), v2)); }

static inline Vec<float> operator + (const mmf & v1, const Vec<float> & v2)
{ return Vec<float>(_vaddf(v1, v2.mm())); }

static inline Vec<float> operator + (const Vec<float> & v1, const float & f)
{ return Vec<float>(_vaddf(v1.mm(), _vset1f(f))); }

static inline Vec<float> operator + (const float & f, const Vec<float> & v2)
...
public:
    ...
    inline mmd mm() const { return _mm; }
    ...
    inline Vec<double> & operator = (const Vec<double> & v) { this->_mm = v.mm(); return *this; }
    inline Vec<double> & operator = (const mmd & _mm) { this->_mm = _mm; return *this; }
#if mmd!=double
    inline Vec<double> & operator = (const double & d) { _mm = _vset1f(d); }
#endif
};

// 向量加
static inline Vec<double> operator + (const Vec<double> & v1, const Vec<double> & v2)
{ return Vec<double>(_vaddd(v1.mm(), v2.mm())); }

static inline Vec<double> operator + (const Vec<double> & v1, const mmd & v2)
{ return Vec<double>(_vaddd(v1.mm(), v2)); }

static inline Vec<double> operator + (const mmd & v1, const Vec<double> & v2)
{ return Vec<double>(_vaddd(v1, v2.mm())); }

static inline Vec<double> operator + (const Vec<double> & v1, const double & d)
{ return Vec<double>(_vaddd(v1.mm(), _vset1d(d))); }

static inline Vec<double> operator + (const double & d, const Vec<double> & v2)
...
inline size_t Vec<float>::mmsize() { return 16; }
inline size_t Vec<double>::mmsize() { return 8; }
#elif defined(__AVX__)
inline size_t Vec<float>::mmsize() { return 8; }
inline size_t Vec<double>::mmsize() { return 4; }
#elif defined(__SSE__)
inline size_t Vec<float>::mmsize() { return 4; }
inline size_t Vec<double>::mmsize() { return 2; }
#else
inline size_t Vec<float>::mmsize() { return 1; }
inline size_t Vec<double>::mmsize() { return 1; }
#endif
