...
public:
    ...
    force_inline Vec<float> &operator=(const Vec<float> &v)
    {
        this->_mm = v.mm();
        return *this;
    }
    force_inline Vec<float> &operator=(const mmf &_mm)
    {
        this->_mm = _mm;
        return *this;
    }
    ...
    force_inline Vec<float> &operator=(const float &f)
    {
        _mm = _vset1f(f);
        return *this;
    }
...
public:
    ...
    force_inline Vec<double> &operator=(const Vec<double> &v)
    {
        this->_mm = v.mm();
        return *this;
    }
    force_inline Vec<double> &operator=(const mmd &_mm)
    {
        this->_mm = _mm;
        return *this;
    }
    ...
    force_inline Vec<double> &operator=(const double &d)
    {
        _mm = _vset1d(d);
        return *this;
    }
